...
public class convert_length extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            cv_convert.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (tempInput.equals("") || tempInput == null) {
                        ...
                        Toast.makeText(convert_length.this, "Wrong Input Type", Toast.LENGTH_SHORT).show();
                    } else {
            ...
            cv_toUnit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final AlertDialog.Builder builder = new AlertDialog.Builder(convert_length.this);
        ...
        /*
        * The following conversion chart might be helpful in navigating through the conversion variables
        * Celsius - meter
        * Farenheit - centimeter
        * Kelvin - millimeter
        * Rankine - kilometer
        * Newton - Megameter
        * Delisle - Nanometer
        * */
        ...
        private String fahrenheitToDelisle(double fahrenheit) {
            double delisle = fahrenheit / 1e+11;
            return String.valueOf(delisle);
        }
