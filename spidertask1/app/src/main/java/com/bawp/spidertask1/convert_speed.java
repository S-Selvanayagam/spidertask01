...
public class convert_speed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cv_toUnit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final AlertDialog.Builder builder = new AlertDialog.Builder(convert_speed.this);
     ...
     * Farenheit - meter/hour
     * Kelvin - meter/minute
     * Rankine - kilometer/hour
     * Newton - kilometer/minute
     * Delisle - Nanometer/second
     * */
